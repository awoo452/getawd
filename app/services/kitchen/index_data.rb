  ...
  class IndexData
    ...
    def call
      ...
      Result.new(
        ...
        recipes_by_type:         Recipe.active.includes(recipe_ingredients: :food_item).ordered.group_by(&:meal_type_suggestion),
        ...
        recipes_for_slot:        MealPlan::SLOTS.index_with { |slot| Recipe.active.by_meal_type(slot).ordered },
