...
FOOD_ITEM_DATA = [
  ...
  ["Rice",                        "side",    "pantry", "bag",       3,  1],
  ["French Fries",                "side",    "freezer",  "bag",       4,  2],
  ["Tater Tots",                  "side",    "freezer",  "bag",       5,  1],
  ["Potato",                      "side",    "pantry", "each",      6,  3],
  ["Mashed Potatoes (Instant)",   "side",    "pantry", "box",       7,  1],
  ["Spaghetti (Noodles)",         "side",    "pantry", "box",       8,  2],
  ["Mac & Cheese",                "side",    "pantry", "box",       9,  3],
  ...
  ["Cereal",                      "side",    "pantry", "box",       18, 1],
  ["Granola",                     "side",    "pantry", "bag",       19, 1],
  ["Oatmeal Packets",             "side",    "pantry", "box",       20, 1],
  ["Refried Beans",               "side",    "pantry", "can",       21, 1],
  ["Chicken Noodle Soup",         "side",    "pantry", "can",       22, 3],

  # Sauces / Condiments / Dairy
  ["Pizza Sauce",                 "sauce",   "pantry", "can",       1,  1],
  ["Spaghetti Sauce (Traditional)", "sauce",  "pantry", "jar",       2,  1],
  ["Spaghetti Sauce (Vodka)",     "sauce",   "pantry", "jar",       3,  1],
  ...
  ["Syrup",                       "sauce",   "pantry", "bottle",    15, 1],
  ["Gravy",                       "sauce",   "pantry", "can",       16, 1],
  ["Peanut Butter",               "sauce",   "pantry", "jar",       17, 1],
  ["Milk",                        "sauce",   "fridge",   "jug",       18, 1],
  ["Colby Jack Cheese",           "sauce",   "fridge",   "bag",       19, 1],
  ["Vanilla Yogurt",              "sauce",   "fridge",   "container", 20, 1],

  # Snacks
  ["Z Bar",                       "snack",   "pantry", "each",      1,  4],
  ["Beef Jerky",                  "snack",   "pantry", "bag",       2,  1],
  ["Cheese Balls",                "snack",   "pantry", "bag",       3,  1],
  ["Popcorn",                     "snack",   "pantry", "bag",       4,  3],
  ["Pretzels - Dots Parmesan Garlic", "snack", "pantry", "bag",       5,  1],
  ["Goldfish",                    "snack",   "pantry", "bag",       6,  2],
  ["Cheez-Its",                   "snack",   "pantry", "box",       7,  1],
  ["Clif Bar",                    "snack",   "pantry", "each",      8,  4],
  ["Chips",                       "snack",   "pantry", "bag",       9,  2],

  # Desserts
  ["Yogurt (Pouch)",              "dessert", "fridge",   "each",      1,  6],
  ["Yogurt (Drink)",              "dessert", "fridge",   "each",      2,  4],
  ["Yogurt (Camping)",            "dessert", "pantry", "each",      3,  2]
].freeze
